  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <c:if test="${userobj.role eq 'admin'}">
      		 <li class="nav-item"><a href="all_film.jsp" class="btn btn-light"><i class="fas fa-user"></i>All Film</a></li>
      		</c:if>
    ...
    <form class="form-inline my-2 my-lg-0" action="/searchjob" method="post">
    	...
    	<c:if test="${not empty userobj }">
    		...
    		<c:if test="${userobj.role eq 'admin' }">
    			<a href="admin.jsp" class="btn btn-light mr-1"><i class="fas fa-sign-in-alt"></i>Admin</a>
    		     <a href="addFilm.jsp" class="btn btn-light"><i class="fas fa-user"></i>New Add Film</a>
    		</c:if>
    		<c:if test="${userobj.role eq 'user' }">
		...
		<c:if test="${empty userobj }">
			...
			<a href="all_film.jsp" class="btn btn-light"><i class="fas fa-user"></i>All Film</a>
		</c:if>
